defmodule Tradebear.Repo.Migrations.InitialMigration do
  @moduledoc """
  ...
  def up do
    ...
    create table(:client_contacts, primary_key: false) do
      add :id, :uuid, null: false, default: fragment("uuid_generate_v4()"), primary_key: true
      add :primary_contact, :boolean, default: false
      ...
      add :contact_id,
          references(:contacts,
            column: :id,
            name: "client_contacts_contact_id_fkey",
            type: :uuid,
            prefix: "public"
          ),
          primary_key: true,
    ...
    create unique_index(:client_contacts, [:client_id, :contact_id],
             name: "client_contacts_unique_link_index"
           )
  end

  def down do
    drop_if_exists unique_index(:client_contacts, [:client_id, :contact_id],
                     name: "client_contacts_unique_link_index"
                   )

    drop constraint(:client_contacts, "client_contacts_client_id_fkey")

    drop constraint(:client_contacts, "client_contacts_contact_id_fkey")
